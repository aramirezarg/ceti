...
frappe.ui.form.on("Trigger Method", {
	onload: function(frm) {
	...
	refresh: function(frm) {
		...
		frappe.trigger_method.setup_fieldname_select(frm);
	...
	event: function(frm) {
		...
		//if(in_list(['Days Before', 'Days After'], frm.doc.event)) {
			frm.add_custom_button(__('Get Alerts for Today'), function() {
				frappe.call({
					method: 'ceti.ceti.doctype.trigger_method.trigger_method.get_documents_for_today',
					args: {
